...
void DeployGraphExecutor() {
  ...
  tvm::runtime::Module mod_factory = tvm::runtime::Module::LoadFromFile("/mnt/project/BetterDL/test/tvm/tmp/linear/tvm/deploy_lib_gpu.so");
  ...
  tvm::runtime::NDArray input_x = tvm::runtime::NDArray::Empty({5}, DLDataType{kDLInt, 64, 1}, cpu_dev);
  tvm::runtime::NDArray input_y = tvm::runtime::NDArray::Empty({5}, DLDataType{kDLInt, 64, 1}, cpu_dev);

  tvm::runtime::NDArray output = tvm::runtime::NDArray::Empty({5}, DLDataType{kDLFloat, 32, 1}, cpu_dev);
